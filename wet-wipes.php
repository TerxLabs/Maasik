...
<body class="animsition">
    ...
    <div class="bread-crumb bgwhite flex-w p-l-52 p-r-15 p-t-30 p-l-15-sm">
        ...
        <a href="personal-hygiene.php" class="s-text16">
			Personal Hygiene
			<i class="fa fa-angle-right m-l-8 m-r-9" aria-hidden="true"></i>
		</a>

        <a href="wet-wipes.php" class="s-text16">
			Wet Wipes
		</a>
    </div>
        ...
        <div class="flex-w flex-sb">
            ...
            <div class="w-size14 p-t-30 respon5">
                ...
                <p class="s-text8 p-t-10">
                    pH balanced enriched with light scent to soothe the skin and reduce the odour.
                </p>
                ...
                <div class="wrap-dropdown-content bo6 p-t-15 p-b-14 active-dropdown-content">
                    ...
                    <div class="dropdown-content dis-none p-t-15 p-b-23">
                        <p class="s-text8">
                            Wet Wipes are moist toilettes are best to carry while you are in the move in the trends. Hygienic and Organic wipes that offers you results worth the money you pay. Offering you clean hygiene throughout the day and that is very good for frequent use.
                        </p>
                    </div>
                </div>
